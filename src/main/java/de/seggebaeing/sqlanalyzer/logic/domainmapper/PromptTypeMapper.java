...
/**
 * Bidirectional mapper between {@link de.seggebaeing.sqlanalyzer.logic.bdo.PromptType} and {@link de.seggebaeing.sqlanalyzer.persistence.dto.PromptTypeDTO}.
 * <p>
...
public class PromptTypeMapper extends AbstractBusinessDomainMapper<PromptType, PromptTypeDTO> {
    ...
    /**
     * Maps a {@link de.seggebaeing.sqlanalyzer.persistence.dto.PromptTypeDTO} to a {@link de.seggebaeing.sqlanalyzer.logic.bdo.PromptType} with caching.
     * <p>
    ...
    /**
     * Maps a {@link de.seggebaeing.sqlanalyzer.logic.bdo.PromptType} to its {@link de.seggebaeing.sqlanalyzer.persistence.dto.PromptTypeDTO} with caching.
