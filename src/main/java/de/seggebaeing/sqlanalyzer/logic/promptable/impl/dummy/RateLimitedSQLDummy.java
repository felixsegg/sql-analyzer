 ...
 * a {@link de.seggebaeing.sqlanalyzer.logic.promptable.exception.RateLimitException} is thrown instead of returning a result.
 */
public class RateLimitedSQLDummy extends SQLDummy {
     ...
     * a {@link de.seggebaeing.sqlanalyzer.logic.promptable.exception.RateLimitException}. Otherwise, it returns the dummy SQL
