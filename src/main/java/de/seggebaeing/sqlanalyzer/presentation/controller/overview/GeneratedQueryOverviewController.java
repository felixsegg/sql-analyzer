...
/**
 * Overview window controller for {@link de.seggebaeing.sqlanalyzer.logic.bdo.GeneratedQuery} entries.
 * Extends {@link de.seggebaeing.sqlanalyzer.presentation.uielements.window.OverviewWindow} to list generated queries,
