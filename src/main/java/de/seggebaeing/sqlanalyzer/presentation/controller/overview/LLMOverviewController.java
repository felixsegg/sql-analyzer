...
/**
 * Overview window controller for {@link de.seggebaeing.sqlanalyzer.logic.bdo.LLM} entries.
 * Extends {@link de.seggebaeing.sqlanalyzer.presentation.uielements.window.OverviewWindow} to provide
