...
import de.seggebaeing.sqlanalyzer.presentation.controller.details.*;
import de.seggebaeing.sqlanalyzer.presentation.controller.general.EvaluationController;
import de.seggebaeing.sqlanalyzer.presentation.controller.general.EvaluationSettingsController;
import de.seggebaeing.sqlanalyzer.presentation.controller.general.GenerationController;
import de.seggebaeing.sqlanalyzer.presentation.controller.general.GenerationSettingsController;
import de.seggebaeing.sqlanalyzer.presentation.controller.overview.*;
 ...
 * Provides creators for {@link de.seggebaeing.sqlanalyzer.presentation.uielements.window.OverviewWindow} (by {@link BdoWindowType}
 * and optional filter), {@link de.seggebaeing.sqlanalyzer.presentation.uielements.window.DetailsWindow} (by concrete
 * {@link de.seggebaeing.sqlanalyzer.logic.bdo.BusinessDomainObject} instance), and general workflow/settings controllers
...
public class ControllerFactory {
     ...
     * @return a new {@link de.seggebaeing.sqlanalyzer.presentation.uielements.window.OverviewWindow} for the requested type
     ...
     * @return a new {@link de.seggebaeing.sqlanalyzer.presentation.uielements.window.DetailsWindow} for the object
     ...
     * @return a new {@link de.seggebaeing.sqlanalyzer.presentation.uielements.window.TitledInitializableWindow} instance
     */
