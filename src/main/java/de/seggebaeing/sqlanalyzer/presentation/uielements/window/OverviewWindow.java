...
/**
 * Abstract base for list/overview windows of {@link de.seggebaeing.sqlanalyzer.logic.bdo.BusinessDomainObject}s.
...
public abstract class OverviewWindow<BDO extends BusinessDomainObject> extends BDOWindow<BDO> {
     ...
     * Creation/de.seggebaeing.sqlanalyzer.persistence should occur only if the user confirms/saves in the details view.
     *
