...
/**
 * Abstract base controller for detail/edit windows of a {@link de.seggebaeing.sqlanalyzer.logic.bdo.BusinessDomainObject}.
...
public abstract class DetailsWindow<T extends BusinessDomainObject> extends BDOWindow<T> {
     ...
     * perform de.seggebaeing.sqlanalyzer.persistence or window navigation.
     */
