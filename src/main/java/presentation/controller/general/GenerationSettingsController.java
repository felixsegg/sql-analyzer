...
public class GenerationSettingsController extends TitledInitializableWindow {
     ...
     *
     * @implNote Numeric options are persisted via {@link logic.service.ConfigService} by the settings object.
     ...
     * and the current selections of {@link logic.bdo.LLM}s and {@link logic.bdo.Prompt}s.
     * Numeric options persist via {@link logic.service.ConfigService} when updated.
     *
