 ...
 * Throws {@link logic.promptable.exception.RateLimitException} if a rate limit
...
public class RateLimitedNumericalDummy extends NumericalDummy {
     ...
     * May throw a {@link logic.promptable.exception.RateLimitException} if the rate limit is active.
     *
