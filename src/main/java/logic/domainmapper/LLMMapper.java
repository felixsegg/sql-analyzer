...
/**
 * Bidirectional mapper between {@link logic.bdo.LLM} and {@link persistence.dto.LLMDTO}.
 * <p>
 ...
 * {@link logic.promptable.util.PromptableApi#valueOf(String)}. For BDO→DTO,
...
public class LLMMapper extends AbstractBusinessDomainMapper<LLM, LLMDTO> {
     ...
     * {@link logic.promptable.util.PromptableApi#valueOf(String)}), updates the
    ...
    /**
     * Maps an {@link LLM} business object to its {@link persistence.dto.LLMDTO} with caching.
     * <p>
     ...
     * @return the mapped {@link persistence.dto.LLMDTO}, or {@code null} if {@code bdo} is {@code null}
     */
    @Override
