...
/**
 * Bidirectional mapper between business domain objects (BDOs) and persistence DTOs.
 * <p>
 * Implementations convert between {@link logic.bdo.BusinessDomainObject} instances and
 * {@link persistence.dto.Persistable} records and may use an injected id supplier for new objects.
 * </p>
 *
...
public interface BusinessDomainMapper<B extends BusinessDomainObject, P extends Persistable> {
    ...
    /**
     * Maps a persistence DTO to its business domain counterpart.
     *
    ...
    /**
     * Maps a business domain object to its persistence DTO.
     *
