...
/**
 * Service layer for managing {@link logic.bdo.Prompt} business objects.
 * <p>
 * Maps between {@link Prompt} and {@link persistence.dto.PromptDTO} via
 * {@link logic.domainmapper.PromptMapper} and persists through
 * {@link persistence.dao.DAOImpl.PromptDAOImpl}. Implements a singleton
 * (use {@link #getInstance()}) and synchronizes public operations for basic
 * thread safety. Provides dependant lookup (e.g., {@link logic.bdo.GeneratedQuery}
